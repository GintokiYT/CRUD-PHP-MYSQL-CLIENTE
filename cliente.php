...
<g>
		...
		<table border="1">
			<tr>
				<td colspan="4">
					<label>Mantenimiento de Clientes</label>
				</td>
			</tr>
			<tr>
				<td colspan="4">
			...
			<tr>
				...
				<td>
					<input type="text" value="" maxlength="7" name="txtcodigo">
				</td>
				<td>
					<label>Edad</label>
				</td>
				<td>	
					<input type="text" value="" maxlength="2" name="txtedad" maxlength="2" size="10">
				</td>
			</tr>
	<tr>
	<td>
	...
	<td>
		<input type="text" value="" maxlength="50" name="txtnombre">
	</td>
	<td>
		<label>Telefono</label>
	</td>
	<td>
		<input type="text" value="" maxlength="9" size="10" name="txttelefono">
	</td>
</tr>
